...
Este curso no es un curso de matemáticas puras ni un curso de "aprende a llamar una API de LLM". Es un curso de **ingeniería de sistemas multiagente**, y esta unidad es su cimiento formal. Cada unidad posterior invocará explícitamente los conceptos aquí introducidos: el Diccionario de Variables de esta unidad reaparecerá en fórmulas de unidades futuras, y la sección de Teoría de la Información/Causalidad (Capítulo 5) se retoma explícitamente en la fase de Evaluación del Ciclo del Agente en la Unidad 3.
